...
---------------------------------------------------------------------- */
	...
	// modified from the original lwPlaceholder() script
		...
		var methods = {
			init : function() {
				return this.each(function() {
					...
					// actually, we removed the check to see if a value is set because it wouldn't work properly in all scenarios
					// if (!$this.val()) {
						...
						// don't need the following bit anymore because we wrote the check into the validation script
...
---------------------------------------------------------------------- */
	...
	*/
	...
	/* 2.4 VALIDATION ---------------------------------------------------------------------- */
	/* jquery-validation-1.9.0/jquery.validate.min.js */
